            ...
            <nav class="space-x-4 md:space-x-6 lg:space-x-8 flex items-center text-sm md:text-base">
                ...
                <a class="hover:text-yellow-400 transition duration-150" href="user_venue_list.php">VENUE LIST</a>
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 hidden z-30" id="dropdownMenu">
                            <a href="/ventech_locator/users/user_login.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-yellow-100 hover:text-gray-900">User</a>
                            ...
                            <a href="index.php?guest_signin=true" class="block px-4 py-2 text-sm text-gray-700 hover:bg-yellow-100 hover:text-gray-900">Sign In as Guest</a>
                        </div>
                    </div>
            ...
            <div class="border rounded-lg shadow-md overflow-hidden bg-white flex flex-col transition duration-300 hover:shadow-xl">
                ...
                <div class="p-4 flex flex-col flex-grow">
                    ...
                    <div class="mt-auto pt-3 border-t border-gray-200 flex space-x-3">
                        ...
                        <a href="/ventech_locator/venue_reservation_form.php?venue_id=<?= $venue['id'] ?>&venue_name=<?= urlencode(htmlspecialchars($venue['title'])) ?>" class="flex-1 text-center px-3 py-2 bg-indigo-600 text-white text-xs font-bold rounded hover:bg-indigo-700 transition shadow-sm">
...
<script>
    ...
    // JavaScript for user dropdown if logged in
    document.addEventListener('DOMContentLoaded', function() {
        const userButton = document.querySelector('#userDropdownMenu')?.previousElementSibling;
        ...
        if (userButton && userDropdown) {
            ...
            document.addEventListener('click', function(event) {
                if (!userDropdown.classList.contains('hidden') && !userButton.contains(event.target)) {
